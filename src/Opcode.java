// Opcode.java - (c) 2001-2020 by Michel de Champlain
//
...
public interface Opcode {
    ...
    public static final String immediateMnemonics[] = { 
    		"br.i5", "brf.i5", "enter.u5", "ldf.i3", "addv.u3", "ldv.u3", "stv.u3", "ldc.i3"
    };
    public static final String relativeMnemonics[] = { 
    		"addv.u8", "ldv.u8", "stv.u8", "incv.u8", "decv.u8", "enter.u8", "lda.i16", "ldc.i8", 
    		"ldc.i16", "ldc.i32", "br.i8", "br.i16", "brf.i8", "calls.i16", "trap"
    };
}
